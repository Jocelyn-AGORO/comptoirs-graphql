...
@gql.django.input(Student, partial=True)
class StudentInput:
    id: gql.auto
    name: gql.auto
    age: gql.auto

@gql.django.partial(Student)
class StudentInputPartial(gql.NodeInput):
    id: gql.auto
    name: gql.auto
    age: gql.auto

@gql.django.input(Course, partial=True)
class CourseInput:
    id: gql.auto
    title: gql.auto
    volume: gql.auto

@gql.django.partial(Course)
class CourseInputPartial(gql.NodeInput):
    id: gql.auto
    title: gql.auto
    volume: gql.auto

@gql.django.input(Employee, partial=True)
class EmployeeInput:
    id: gql.auto
    title: gql.auto
    supervisor: gql.auto

@gql.django.partial(Employee)
